...
API_HASH = environ.get('API_HASH', '9e4430929d7757512f864d160dac0a98')
BOT_TOKEN = environ.get('BOT_TOKEN', '7466237639:AAFYQkVd3sw6o-BOsWrRmrlSvpsGmsyogw4')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002212033482')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://michealachayan2:Hemanthss2004@cluster0.2jltqv9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002212033482'))
